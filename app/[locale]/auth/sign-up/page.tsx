      ...
      <div className="flex flex-col items-center justify-center p-8 lg:p-12 relative z-10 overflow-y-auto border-r border-border/50">
        ...
        <div className="absolute top-8 left-8 right-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-1.5 h-1.5 rounded-full bg-primary shadow-[0_0_10px_rgba(var(--primary),0.6)]" />
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative py-2">
                ...
                <div className="relative flex justify-center text-[9px] font-black uppercase tracking-[0.3em]">
                  <span className="bg-background px-4 text-muted-foreground/60 italic">Or Initial Gate</span>
                </div>
              </div>
        ...
        <div className="relative z-10 w-full max-w-lg space-y-16 animate-in fade-in zoom-in-95 duration-1000">
          <div className="space-y-6">
            ...
            <h2 className="text-6xl font-black tracking-tighter text-white leading-[0.9] uppercase">
              Scale Your <br /><span className="text-primary">Operation.</span>
            </h2>
          ...
          <div className="space-y-4">
            {[
              { icon: Globe, title: "Universal Ledger", desc: "Native multi-currency support with real-time exchange validation.", color: "text-primary" },
          ...
          <div className="p-8 rounded-3xl bg-primary/5 border border-primary/10 backdrop-blur-md relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="flex -space-x-3">
                {[1, 2, 3].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-[#06060a] bg-linear-to-tr from-primary to-primary/60 flex items-center justify-center text-[11px] font-black text-white uppercase">
                    A{i}
                  </div>
                ))}
              </div>
              <span className="text-[10px] text-primary font-black uppercase tracking-widest pl-2 border-l border-white/10 ml-2">Verified Founders</span>
            </div>
